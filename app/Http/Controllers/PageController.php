        ...
        return view('home', [
            'students' => [
                [
                    'name' => 'Mitra Partogi',
                    'nrp' => '5025241017',
                    'origin' => 'Asal daerah belum diisi',
                    ...
                    'education' => [
                        'Institut Teknologi Sepuluh Nopember (ITS) - S1 Teknik Informatika (2024 - Sekarang), IPK: 3.77/4.00',
                        'SMAN 15 Surabaya - MIPA (2021 - 2024), Nilai: 92.76/100.00',
                    ],
                    'work' => [
                        'Dinas Pendidikan Jawa Timur (Mei 2026 - Sekarang) - Front End Engineer: Mengembangkan sistem PPDB/SPMB Jawa Timur berskala provinsi dengan arsitektur monorepo Next.js, React, dan TypeScript.',
                        'Institut Teknologi Sepuluh Nopember (Feb 2026 - Sekarang) - Asisten Dosen Sistem Operasi dan Struktur Data (C/C++).',
                        'Institut Teknologi Sepuluh Nopember (Sep 2025 - Sekarang) - Asisten Dosen Dasar Pemrograman (C).',
                    ],
                    'organization' => [
                        ...
                        'DHELIBELS (Agu 2022 - Apr 2024) - Duta Hemat Energi untuk program KESDM RI dan IIEE.',
                    ],
